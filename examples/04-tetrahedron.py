...
class Canvas(app.Canvas):
    ...
    def __init__(self):
        ...
        app.Canvas.__init__(
            self, size=(512, 512), title="tetrahedron", keys="interactive"
        )
        ...
        I = np.array([(0, 1, 2), (0, 3, 1), (0, 2, 3), (1, 3, 2)], dtype=np.uint32)
        # edges, used for drawing outline
        E = np.array([(0, 1), (1, 2), (2, 0), (1, 3), (2, 3), (0, 3)], dtype=np.uint32)
        # colors of vertices
        C = np.array(
